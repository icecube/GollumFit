...
PYBIND11_MODULE(GollumFitPy, m)
{
 ...
 ;
  ...
  py::class_<GF::GollumFit, std::shared_ptr<GF::GollumFit> >(m, "GollumFit")
    ...
    .def("GetStartingDataDistribution",&GF::GollumFit::GetStartingDataDistribution)
    .def("GetThroughgoingDataDistribution",&GF::GollumFit::GetThroughgoingDataDistribution)
