...
int main(int argc, char* argv[]){
  ...
  nuSQUIDSAtm<> nus_atm_prompt(linspace(-1.,0.2,100),logspace(1.e2*units.GeV,1.e6*units.GeV,350),numneu,both,true);
  ...
  nus_atm_prompt.Set_MixingAngle(0,1,0.585732);
  nus_atm_prompt.Set_MixingAngle(0,2,0.147655);
  nus_atm_prompt.Set_MixingAngle(1,2,0.726057);
  nus_atm_prompt.Set_MixingAngle(0,3,th14);
  nus_atm_prompt.Set_MixingAngle(1,3,th24);
  nus_atm_prompt.Set_MixingAngle(2,3,th34);

  nus_atm_prompt.Set_SquareMassDifference(1,7.50e-05);
  nus_atm_prompt.Set_SquareMassDifference(2,0.00252);
  nus_atm_prompt.Set_SquareMassDifference(3,dm41sq);

  nus_atm_prompt.Set_CPPhase(0,2,0.0);
  nus_atm_prompt.Set_CPPhase(0,3,del14);
  nus_atm_prompt.Set_CPPhase(1,3,del24);
  ...
  nus_atm_prompt.WriteStateHDF5(output_path+"/prompt_atmospheric_"+std::to_string(index)+"_"+std::to_string(dm41sq)+"_"+std::to_string(th14)+"_"+std::to_string(th24)+"_"+std::to_string(th34)+"_"+std::to_string(del14)+"_"+std::to_string(del24)+".hdf5");
