...
int main(int argc, char* argv[]){
  ...
  nus_atm.WriteStateHDF5(output_path+"/"+flux_name+"_"+std::to_string(index)+"_"+std::to_string(dm41sq)+"_"+std::to_string(th14)+"_"+std::to_string(th24)+"_"+std::to_string(th34)+"_"+std::to_string(del14)+"_"+std::to_string(del24)+".hdf5");
