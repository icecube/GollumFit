...
For details on the code, installation, usage, and examples, please visit the official documentation at [https://docs.icecube.aq/golemfit/main/index.html](https://docs.icecube.aq/golemfit/main/index.html).


## Getting Started

To build and run GollumFit, follow the instructions in the [installation manual](https://docs.icecube.aq/golemfit/main/md__home_runner_work_GollumFit_GollumFit_docs_manual_installation.html).
